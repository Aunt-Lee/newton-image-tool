...
- 默认服务地址：`https://image.newtonrouter.com`。
- 支持 `Generations` 和 `Chat Stream` 两种生成方式。
- 分辨率选项：`1024x1024`、`1536x1024`、`1024x1536`、`2048x2048`、`2048x1152`、`3840x2160`、`2160x3840`、`auto`。
